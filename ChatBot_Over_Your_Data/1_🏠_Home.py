...
st.set_page_config(
    page_title="Build a AI2Us bot, powered by LlamaIndex",
    page_icon="🦙",
    layout="centered",
    initial_sidebar_state="auto",
    menu_items=None,
)
st.title("Build a AI2Us bot, powered by LlamaIndex 💬🦙")
st.info(
    "Use this page to build your AI2U bot over your data! "
    "Once the agent is finished creating, check out the `AI2U Config` and "
    "`Generated AI2U Agent` pages.\n"
...
if "messages" not in st.session_state.keys():  # Initialize the chat messages history
    st.session_state.messages = [
        {"role": "assistant", "content": "What AI2U bot do you want to build?"}
    ]
